...
export default function AdminEducationalMaterials() {
  ...
  const fetchItems = async () => {
    const res = await fetch((import.meta.env.VITE_API_URL || 'http://localhost:5000') + '/api/educational-materials');
  ...
  const handleDelete = async (id: number) => {
    ...
    await fetch((import.meta.env.VITE_API_URL || 'http://localhost:5000') + '/api/educational-materials', {
      method: 'DELETE',
      headers: { 'Content-Type': 'application/json' },
